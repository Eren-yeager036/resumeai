...
const Button = forwardRef(({ 
  ...
  const variants = {
    primary: 'bg-primary text-white hover:bg-emerald-600 shadow-[0_8px_16px_-4px_rgba(0,200,83,0.4)] hover:shadow-[0_12px_20px_-4px_rgba(0,200,83,0.5)] focus:ring-primary',
    secondary: 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 shadow-sm hover:shadow focus:ring-gray-200',
